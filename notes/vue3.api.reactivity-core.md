...
- [[vue3.guide.essentials.reactivity-fundamentals]] (with the API preference set to Composition API)
- [[vue3.guide.extras.reactivity-in-depth]]
  :::
...
- **Details**
  ...
  If an object is assigned as a ref's value, the object is made deeply reactive with [[vue3.#reactive]]. This also means if the object contains nested refs, they will be deeply unwrapped.

  To avoid the deep conversion, use [[vue3.reactivity-advanced#shallowref]] instead.
...
- **See also:**
  - [[vue3.guide.essentials.reactivity-fundamentals#reactive-variables-with-ref]]
  - [[vue3.guide.typescript.composition-api#typing-ref]]

## computed()

Takes a getter function and returns a readonly reactive [[vue3.#ref]] object for the returned value from the getter. It can also take an object with `get` and `set` functions to create a writable ref object.
...
- **See also:**
  - [[vue3.guide.essentials.computed]]
  - [[vue3.guide.extras.reactivity-in-depth#computed-debugging]]
  - [[vue3.guide.typescript.composition-api#typing-computed]]
...
- **Details**
  ...
  The reactive conversion is "deep": it affects all nested properties. A reactive object also deeply unwraps any properties that are [[vue3.#ref]] while maintaining reactivity.
  ...
  To avoid the deep conversion and only retain reactivity at the root level, use [[vue3.reactivity-advanced#shallowreactive]] instead.
...
- **Example**
  ...
  When assigning a [[vue3.#ref]] to a `reactive` property, that ref will also be automatically unwrapped:
...
- **See also:**
  - [[vue3.guide.essentials.reactivity-fundamentals]]
  - [[vue3.guide.typescript.composition-api#typing-reactive]]

## readonly()

Takes an object (reactive or plain) or a [[vue3.#ref]] and returns a readonly proxy to the original.
...
- **Details**
  ...
  To avoid the deep conversion, use [[vue3.reactivity-advanced#shallowreadonly]] instead.
...
- **See also**:
  - [[vue3.guide.essentials.watchers#watcheffect]]
  - [[vue3.guide.extras.reactivity-in-depth#watcher-debugging]]

## watchPostEffect()

Alias of [[vue3.#watcheffect]] with `flush: 'post'` option.

## watchSyncEffect()

Alias of [[vue3.#watcheffect]] with `flush: 'sync'` option.
...
- **Details**
  ...
  - **`deep`**: force deep traversal of the source if it is an object, so that the callback fires on deep mutations. See [[vue3.guide.essentials.watchers#deep-watchers]].
  - **`flush`**: adjust the callback's flush timing. See [[vue3.guide.essentials.watchers#callback-flush-timing]].
  - **`onTrack / onTrigger`**: debug the watcher's dependencies. See [[vue3.guide.extras.reactivity-in-depth#watcher-debugging]].

  Compared to [[vue3.#watcheffect]], `watch()` allows us to:
...
- **Example**
  ...
  `watch()` shares the same flush timing and debugging options with [[vue3.#watcheffect]]:
...
- **See also**:
  ...
  - [[vue3.guide.essentials.watchers]]
  - [[vue3.guide.extras.reactivity-in-depth#watcher-debugging]]
