...
You can use Vue to [[vue3.guide.extras.web-components]] that can be embedded in any HTML page, regardless of how they are rendered. This option allows you to leverage Vue in a completely consumer-agnostic fashion: the resulting web components can be embedded in legacy applications, static HTML, or even applications built with other frameworks.
...
Vue provides core libraries and [[vue3.guide.scaling-up.tooling]] with amazing developer experience for building modern SPAs, including:
...
- Use Vue's [[vue3.api.custom-renderer]] to build custom renderers targeting [WebGL](https://troisjs.github.io/) or even [the terminal](https://github.com/ycmjason/vuminal)!
