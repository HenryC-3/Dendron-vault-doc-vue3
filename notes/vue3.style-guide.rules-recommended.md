---
id: dkmp0e20vtjvck7jojgodx1
title: Rules Recommended
desc: ''
...
**[[vue3.guide.scaling-up.sfc]] should always order `<script>`, `<template>`, and `<style>` tags consistently, with `<style>` last, because at least one of the other two is always necessary.**
