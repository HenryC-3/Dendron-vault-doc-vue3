...
You can combine `<Teleport>` with [[vue3.transition]] to create animated modals - see [[vue3.examples.#modal]].
...
- [[vue3.api.built-in-components#teleport]]
- [[vue3.guide.scaling-up.ssr#teleports]]
