...
When using them in [[vue3.guide.extras.render-function]], they need to be imported explicitly. For example:
...
- **See also:** [[vue3.guide.built-ins.transition]]
...
- **Details**
  ...
  Note that every child in a `<transition-group>` must be [[vue3.guide.essentials.list#maintaining-state-with-key]] for the animations to work properly.
...
- **See also:** [[vue3.guide.built-ins.transition-group]]
...
- **See also:** [[vue3.guide.built-ins.keep-alive]]
...
- **See also:** [[vue3.guide.built-ins.teleport]]
...
- **Details**
  ...
  If it encounters async dependencies ([[vue3.guide.components.async]] and components with [[vue3.guide.built-ins.suspense#async-setup]]) while rendering the default slot, it will wait until all of them are resolved before displaying the default slot.

- **See also:** [[vue3.guide.built-ins.suspense]]
