...
- **See also:** [[vue3.api.component-instance#nexttick]]
...
- **See also:** [[vue3.guide.typescript.overview#general-usage-notes]]
...
- **See also:** [[vue3.guide.components.async]]

## defineCustomElement()

This method accepts the same argument as [[vue3.#definecomponent]], but instead returns a native [Custom Element](https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements) class constructor.
...
- **See also:**
  ...
  - [[vue3.guide.extras.web-components#building-custom-elements-with-vue]]

  - Also note that `defineCustomElement()` requires [[vue3.guide.extras.web-components#sfc-as-custom-element]] when used with Single-File Components.
