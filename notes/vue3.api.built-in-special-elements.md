---
id: pugkvpqg2nfj6m1hcqssbz9
title: Built in Special Elements
desc: ''
...
- **Example**
  ...
  The [[vue3.built-in-components]] can all be passed to `is`, but you must register them if you want to pass them by name. For example:
...
- **See also:** [[vue3.guide.essentials.component-basics#dynamic-components]]
...
- **See also:** [[vue3.guide.components.slots]]
