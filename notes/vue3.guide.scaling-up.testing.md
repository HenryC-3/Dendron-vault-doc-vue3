...
There is one Vue-specific section covering composables. See [[vue3.#testing-composables]] below for more details.
...
One category of functions specific to Vue applications are [[vue3.guide.reusability.composables]], which may require special handling during tests.
See [[vue3.#testing-composables]] below for more details.
...
2. Blackbox: Component Testing
   ...
   Tests that are "Blackbox tests" are unaware of the implementation details of a component. These tests mock as little as possible to test the integration of your component and the entire system. They usually render all child components and are considered more of an "integration test". See the [[vue3.#component-testing]] below.
...
> This section assumes you have read the [[vue3.guide.reusability.composables]] section.
...
For more complex composables, it could also be easier to test it by writing tests against the wrapper component using [[vue3.#component-testing]] techniques.
