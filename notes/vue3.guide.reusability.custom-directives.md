...
We have introduced two forms of code reuse in Vue: [[vue3.guide.essentials.component-basics]] and [[vue3.composables]]. Components are the main building blocks, while composables are focused on reusing stateful logic. Custom directives, on the other hand, are mainly intended for reusing logic that involves low-level DOM access on plain elements.
...
When used on components, custom directives will always apply to a component's root node, similar to [[vue3.guide.components.attrs]].
