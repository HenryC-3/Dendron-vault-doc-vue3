...
- During development, we recommend relying on a good [[vue3.#ide-support]] for instant feedback on type errors.
...
- Vue CLI also provides TypeScript support, but is no longer recommended. See [[vue3.#note-on-vue-cli-and-ts-loader]].
...
To let TypeScript properly infer types inside component options, we need to define components with [[vue3.api.general#definecomponent]]:
...
- [[vue3.api.general#note-on-webpack-treeshaking]]
