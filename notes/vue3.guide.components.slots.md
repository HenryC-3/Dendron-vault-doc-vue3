...
![slot diagram](/assets/slots-xagg3k1420my.png)
...
![named slots diagram](/assets/named-slots-weqzdrschqqo.png)
...
[[vue3.guide.essentials.template-syntax.md#dynamic-arguments]] also work on `v-slot`, allowing the definition of dynamic slot names:
...
Do note the expression is subject to the [[vue3.guide.essentials.template-syntax#directives]] of dynamic directive arguments.

## Scoped Slots

As discussed in [[vue3.#render-scope]], slot content does not have access to state in the child component.
...
![scoped slots diagram](/assets/scoped-slots-3o54slqdj2cy.svg)
...
In fact, this is very close to how scoped slots are compiled, and how you would use scoped slots in manual [[vue3.guide.extras.render-function]].
