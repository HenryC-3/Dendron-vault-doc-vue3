...
- **See also:** [[vue3.guide.essentials.application]]

## createSSRApp()

Creates an application instance in [[vue3.guide.scaling-up.ssr#client-hydration]] mode. Usage is exactly the same as `createApp()`.
...
- **Details**
  ...
  In SSR hydration mode, it will hydrate the existing DOM nodes inside the container. If there are [[vue3.guide.scaling-up.ssr#hydration-mismatch]], the existing DOM nodes will be morphed to match the expected output.
...
- **See also:**
  - [[vue3.guide.components.provide-inject]]
  - [[vue3.guide.components.provide-inject#app-level-provide]]
...
Installs a [[vue3.guide.reusability.plugins]].
...
- **See also:** [[vue3.guide.reusability.plugins]]
...
For logic reuse, prefer [[vue3.guide.reusability.composables]] instead.
:::
...
Provides the version of Vue that the application was created with. This is useful inside [[vue3.guide.reusability.plugins]], where you might need conditional logic based on different Vue versions.
...
- **See also:** [[vue3.api.general#version]]
...
- **See also:** [[vue3.guide.best-practices.performance]]

## app.config.compilerOptions

Configure runtime compiler options. Values set on this object will be passed to the in-browser template compiler and affect every component in the configured app. Note you can also override these options on a per-component basis using the [[vue3.api.options-rendering#compileroptions]].
...
- **See also:** [[vue3.guide.extras.web-components]]
...
- **See also:** [[vue3.api.component-instance#options]]
