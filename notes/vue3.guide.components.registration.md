...
We can make components available globally in the current [[vue3.guide.essentials.application]] using the `app.component()` method:
...
This is the recommended style when working with SFC or string templates. However, as discussed in [[vue3.guide.essentials.component-basics#dom-template-parsing-caveats]], PascalCase tags are not usable in DOM templates.
