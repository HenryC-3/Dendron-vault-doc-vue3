...
- **Details**
  ...
  `v-text` works by setting the element's [textContent](https://developer.mozilla.org/en-US/docs/Web/API/Node/textContent) property, so it will overwrite any existing content inside the element. If you need to update the part of `textContent`, you should use [[vue3.guide.essentials.template-syntax#text-interpolation]] instead.
...
- **See also:** [[vue3.guide.essentials.template-syntax#text-interpolation]]
...
- **Details:**
  ...
  In [[vue3.guide.scaling-up.sfc]], `scoped` styles will not apply to content inside `v-html`, because that HTML is not processed by Vue's template compiler. If you want to target `v-html` content with scoped CSS, you can instead use [[vue3.sfc-css-features#css-modules]] or an additional, global `<style>` element with a manual scoping strategy such as BEM.
...
- **See also:** [[vue3.guide.essentials.template-syntax#raw-html]]
...
- **See also:** [[vue3.guide.essentials.conditional#v-show]]
...
- **Details**
  ...
  When used together, `v-if` has a higher priority than `v-for`. We don't recommend using these two directives together on one element — see the [[vue3.guide.essentials.list#v-for-with-v-if]] for details.

- **See also:** [[vue3.guide.essentials.conditional#v-if]]
...
- **See also:** [[vue3.guide.essentials.conditional#v-else]]
...
- **See also:** [[vue3.guide.essentials.conditional#v-else-if]]
...
- **See also:**
  - [[vue3.guide.essentials.event-handling]]
  - [[vue3.guide.essentials.component-basics#listening-to-events]]
...
- **See also:**
  - [[vue3.guide.essentials.class-and-style]]
  - [[vue3.guide.components.props#prop-passing-details]]
...
- **Modifiers:**
  ...
  - [[vue3.guide.essentials.forms#lazy]] - listen to `change` events instead of `input`
  - [[vue3.guide.essentials.forms#number]] - cast valid input string to numbers
  - [[vue3.guide.essentials.forms#trim]] - trim input

- **See also:**

  - [[vue3.guide.essentials.forms]]
  - [[vue3.guide.components.events#usage-with-v-model]]
...
- **Limited to:**
  ...
  - `<template>`
  - [[vue3.guide.components.slots#scoped-slots]] (for a lone default slot with props)
...
- **Details**
  ...
  Since 3.2, you can also memoize part of the template with invalidation conditions using [[vue3.#v-memo]].

- **See also:**
  - [[vue3.guide.essentials.template-syntax#text-interpolation]]
  - [[vue3.#v-memo]]
