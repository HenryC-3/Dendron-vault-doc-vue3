...
The object returned from the [[vue3.options-state#data]] option, made reactive by the component. The component instance proxies access to the properties on its data object.
...
- **Details**
  ...
  Only props declared via the [[vue3.options-state#props]] option will be included. The component instance proxies access to the properties on its props object.
...
- **Details**
  ...
  `$el` will be `undefined` until the component is [[vue3.options-lifecycle#mounted]].
  ...
  :::tip
  For consistency, it is recommended to use [[vue3.guide.essentials.template-refs]] for direct access to elements instead of relying on `$el`.
  :::
...
- **See also:** [[vue3.api.application#app-config-optionmergestrategies]]
...
An object representing the [[vue3.guide.components.slots]] passed by the parent component.
...
- **Details**
  ...
  Typically used when manually authoring [[vue3.guide.extras.render-function]], but can also be used to detect whether a slot is present.
  ...
  If a slot is a [[vue3.guide.components.slots#scoped-slots]], arguments passed to the slot functions are available to the slot as its slot props.

- **See also:** [[vue3.guide.extras.render-function#rendering-slots]]

## $refs

An object of DOM elements and component instances, registered via [[vue3.guide.essentials.template-refs]].
...
- **See also:**
  ...
  - [[vue3.guide.essentials.template-refs]]
  - [[vue3.built-in-special-attributes.md#ref]]
...
- **Details**
  ...
  [[vue3.guide.components.attrs]] are attributes and event handlers passed by the parent component, but not declared as a prop or an emitted event by the child.

  By default, everything in `$attrs` will be automatically inherited on the component's root element if there is only a single root element. This behavior is disabled if the component has multiple root nodes, and can be explicitly disabled with the [[vue3.options-misc#inheritattrs]] option.

- **See also:**

  - [[vue3.guide.components.attrs]]
...
- **See also:**
  ...
  - [[vue3.guide.components.events]]
  - [[vue3.options-state#emits]]
...
Instance-bound version of the global [[vue3.general#nexttick]].
...
- **See also:** [[vue3.general#nexttick]]
