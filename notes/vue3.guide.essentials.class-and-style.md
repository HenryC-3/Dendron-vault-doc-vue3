...
This will render the same result. We can also bind to a [[vue3.computed]] that returns an object. This is a common and powerful pattern:
...
You can learn more about component attribute inheritance in [[vue3.guide.components.attrs]] section.
